...
if __name__=="__main__":
    ...
    if 'rsv' in args.lineage.lower():
        ...
        max_date, min_date = 4000, 0
        cutoff=1.0
        # These params determine how many epitope mutations are required at epitope sites (bushines_branch_scale) or any site (divergence_scale) to define a new clade
        bushiness_branch_scale = 1.0
    ...
    print(f"Suggesting {len(new_clades)} new clades")
